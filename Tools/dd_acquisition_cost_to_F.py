# ============================================
# Script: add_acquisition_cost_to_F_hardcoded.py
# ============================================
...
# acquisition_cost = terreno + estrategico
# =============================
acquisition_costs = {
    # -------- CDs --------
    "DC_Maipu": 5726500.00,
...
try:
    cursor.execute("""
        ALTER TABLE F
        ADD COLUMN acquisition_cost_usd REAL
    """)
    print("[OK] Column 'acquisition_cost_usd' added.")
...
# UPDATE VALUES
# =============================
for facility, cost in acquisition_costs.items():
    cursor.execute("""
        UPDATE F
        SET acquisition_cost_usd = ?
        WHERE facility_name = ?
    """, (cost, facility))

print("[OK] acquisition_cost_usd updated for all facilities.")
